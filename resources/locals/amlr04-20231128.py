...
# glider_path = os.path.join(deployment_curr_path)
...
gdm = amlr_gdm(
    deployment, project, mode, deployment_curr_path, numcores, 
    loadfromtmp = False, clobbertmp = True
)
prof = gdm.profiles
